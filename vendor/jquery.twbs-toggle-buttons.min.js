/*
 Twitter Bootstrap Toogle Buttons 0.0.4
...
1):b.push(c);this._resetDOM(b);window.setTimeout(function(){if("function"===typeof Event)var b=new Event("twbsToggleButtons:activate");else b=document.createEvent("Event"),b.initEvent("twbsToggleButtons:activate",!0,!0);a.target.dispatchEvent(b)},0);return!0};
